...
public class Testblackjack {
	...
	public void checkHand(Field deck, Field player, Field dealer,
			Field checkBlackJack, Boolean isBlackJack)
	...
	public void test() throws IllegalArgumentException, SecurityException,
		...
		assertFalse("shuffled and unshuffled decks",
				d1.getCards().equals(d2.getCards()));
		// check if hand Player(A,10), Dealer(A,10) is draw (PUSH),provide
		// unshuffle just to check
